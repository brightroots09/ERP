...
export class UserService {
  ...
  private _editProjectEmployee = "http://localhost:8080/admin/edit_project_employee";
  private _editProjectManager = "http://localhost:8080/admin/edit_project_manager";
  private _editResponsiblePerson = "http://localhost:8080/admin/editResponsiblePerson";
  ...
  private _changePasswordUrl = "http://localhost:8080/employee/change_password";
  ...
  private _attendanceDetailsUrl = "http://localhost:8080/employee/attendance_details";
  private _updateAttendanceUrl = "http://localhost:8080/employee/update_daily_dairy";
